...
Model_u850_files             = yml_input [ 'Path to zonal wind at 850 hPa data files for Extratropical Cyclone Activity' ]
...
if (yml_input['ERAI']==False):
    ...
    reanalysis_v850_file=yml_input['Extratropical Cyclone Activity meridional wind at 850 hPa observation data files']
