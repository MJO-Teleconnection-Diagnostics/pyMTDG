...
def calcAnom(ds,var_name,anom_name):
    ...
    for i in range(nlead):
        da=ds[var_name][i:ntimes-1:nlead,:,:].mean(dim='time')
    ...
    # Compute anomalies 
    anoms=ds[var_name].groupby(ds.time)-ds_clim
  ...
  ### Plan to add the regridding coded shareed by Cheng
