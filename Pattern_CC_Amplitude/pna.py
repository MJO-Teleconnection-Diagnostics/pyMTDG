...
if (dictionary['Daily Anomaly'] == False):
    z500_obs_anom=copy.deepcopy(rgrd_z500_obs)
    del z500_obs
...
pcc_ufs_p23 = patterncc(timelag,rmm_list_obs_23,rmm_list_model_23,z500_fcst_anom_reshape,z500_obs_anom, lat_min,lat_max,lon_min,lon_max)
pcc_ufs_p67 = patterncc(timelag,rmm_list_obs_67,rmm_list_model_67,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max)       
pcc_ufs_p23=np.mean ( pcc_ufs_p23,axis= 1   )
pcc_ufs_p67=np.mean ( pcc_ufs_p67,axis= 1   )


amp_ufs_p23 = amplitude_metric(timelag,rmm_list_obs_23,rmm_list_model_23,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max)
amp_ufs_p67 = amplitude_metric(timelag,rmm_list_obs_67,rmm_list_model_67,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max)       
amp_ufs_p23=np.mean ( amp_ufs_p23,axis= 1   )
amp_ufs_p67=np.mean ( amp_ufs_p67,axis= 1   )

bootstrap_size = 1000
P23_PNA_low,P23_PNA_high=test_significance(bootstrap_size,timelag,rmm_list_obs_23,rmm_list_model_23,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max,PCC=True)
P67_PNA_low,P67_PNA_high=test_significance(bootstrap_size,timelag,rmm_list_obs_67,rmm_list_model_67,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max,PCC=True)
P23_PNA_low_amp,P23_PNA_high_amp=test_significance(bootstrap_size,timelag,rmm_list_obs_23,rmm_list_model_23,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max,amp=True)
P67_PNA_low_amp,P67_PNA_high_amp=test_significance(bootstrap_size,timelag,rmm_list_obs_67,rmm_list_model_67,z500_fcst_anom_reshape,z500_obs_anom,lat_min,lat_max,lon_min,lon_max,amp=True)
...
#########PNA region#############
    ...
    for i in range ( 4 ) :
        res_temp_p23=correlate(xr_obs_z500_composite_p23[i,:,:],
                               xr_model_z500_composite_p23[i,:,:],lat_min,lat_max,lon_min,lon_max)
        res_temp_p67=correlate(xr_obs_z500_composite_p67[i,:,:],
...
# Plot PNA region Z500 composites
   ...
   # save
    if not os.path.exists('../output/PatternCC_PNA/'+ds_fcst_name): 
        os.mkdir('../output/PatternCC_PNA/'+ds_fcst_name)
    figname='z500_composites_PNA' 
    fig.savefig('../output/PatternCC_PNA/'+ds_fcst_name+'/'+figname+'.jpg',dpi=300)
