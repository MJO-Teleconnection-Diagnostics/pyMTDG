...
bootstrap_size = 1000
P23_atlantic_low,P23_atlantic_high=test_significance_atlantic(bootstrap_size,timelag,rmm_list_ERA_23,rmm_list_model_23,z500_fcst_anom_reshape,erai_anomaly,lat_min,lat_max,lon_min,lon_max,PCC=True)
P67_atlantic_low,P67_atlantic_high=test_significance_atlantic(bootstrap_size,timelag,rmm_list_ERA_67,rmm_list_model_67,z500_fcst_anom_reshape,erai_anomaly,lat_min,lat_max,lon_min,lon_max,PCC=True)
P23_atlantic_low_amp,P23_atlantic_high_amp=test_significance_atlantic(bootstrap_size,timelag,rmm_list_ERA_23,rmm_list_model_23,z500_fcst_anom_reshape,erai_anomaly,lat_min,lat_max,lon_min,lon_max,amp=True)
P67_atlantic_low_amp,P67_atlantic_high_amp=test_significance_atlantic(bootstrap_size,timelag,rmm_list_ERA_67,rmm_list_model_67,z500_fcst_anom_reshape,erai_anomaly,lat_min,lat_max,lon_min,lon_max,amp=True)
...
write_output_text('../output/PatternCC_Atlantic/'+dictionary['model name']+'/'+figname,
