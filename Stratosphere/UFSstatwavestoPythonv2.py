...
# based on https://github.com/cristianastan2/MJO-Teleconnections/blob/develop/Utils/t2m_utils.py
        ...
        if not os.path.exists('../output/statwaves/'): 
            os.mkdir('../output/statwaves/')
        fig.savefig('../output/statwaves/Zstat' + ds_fcst_name + '.jpg',dpi=300)
...
# based on https://github.com/cristianastan2/MJO-Teleconnections/blob/develop/Utils/t2m_utils.py
        ...
        if not os.path.exists('../output/statwaves/'): 
            os.mkdir('../output/statwaves/')
        fig.savefig('../output/statwaves/Zstat' + ds_obs_name + '.jpg',dpi=300)
